...
public:
  ...
  virtual void do_fun_call_node(xpl::fun_call_node * const node, int lvl) = 0;
  virtual void do_fun_decl_node(xpl::fun_decl_node * const node, int lvl) = 0;
  virtual void do_fun_def_node(xpl::fun_def_node * const node, int lvl) = 0;
  ...
  virtual void do_memory_alloc_node(xpl::memory_alloc_node * const node, int lvl) = 0;
  virtual void do_pos_indication_node(xpl::pos_indication_node * const node, int lvl) = 0;
  ...
  virtual void do_variable_node(xpl::variable_node * const node, int lvl) = 0;
